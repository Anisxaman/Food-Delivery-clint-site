...
import {    faBoxOpen, faSignInAlt, faSignOutAlt } from "@fortawesome/free-solid-svg-icons";
...
<div className="container-fluid" style={{ backgroundColor:"rgb(41, 30, 65)"}} >
  <a className="navbar-brand ms-5" style={{fontSize:"35px"}} href="/shop"><span className="focusName text-danger fw-bolder"><img className="ms-2" src={panda} alt="" width="80" /> FOOD</span>pandi<FontAwesomeIcon icon={faBoxOpen} className="text-white ms-4 scope" style={{fontSize:"50px"}}></FontAwesomeIcon>
</a>
